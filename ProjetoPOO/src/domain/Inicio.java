...
public class Inicio {
	...
	public static void abertura() {
		...
		JOptionPane.showMessageDialog(null, "Esse é um jogo de RPG onde suas escolhas"
				+ "\ne sua sorte influenciarão no seu destino!" + "\n \nNão afobe não!", "Clique em 'Ok' para prosseguir",
	...
	public static void faseUm() {
		...
		case 1:
			...
			case 1:
				...
				JOptionPane.showMessageDialog(null, "Parabéns, o treino na academia se mostrou muito efetivo."
						+ "\nAgora sua força subiu para: " + protagonista.getForca()
			...
			case 2:
				...
				JOptionPane.showMessageDialog(null, "Sua habilidade não melhorou muito, mas "
						+ "\nagora você já pode participar de uma briga de rua."
						+ "\n\nSua força subiu para: " + protagonista.getForca()
						+ "\nComo treinou sem equipamentos, sua saúde agora é: " + protagonista.getVida()
		...
		case 2:
			...
			int option3 = new Integer(JOptionPane.showInputDialog(null, "1. Tentar novamente? \n2.Sair",
					"Faça sua escolha!", JOptionPane.PLAIN_MESSAGE)).intValue();
			switch (option3) {
			case 1:
				faseUm();
